...
export default function Sidebar() {
  ...
  const items = [
    {
      label: <Link to="/staff/hang-ton-kho">Danh sách hàng tồn kho</Link>,
      icon: <InsertRowBelowOutlined />,
      key: "/staff/hang-ton-kho",
    }, {
      label: <Link to="/staff/hang-xuat-kho">Danh sách hàng xuất kho</Link>,
      icon: <InsertRowAboveOutlined />,
      key: "/staff/hang-xuat-kho",
    },
  ];
